            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ url('/animal-cruelty') }}" class="w-full block text-center bg-red-500 text-white py-3 rounded-xl font-semibold hover:bg-red-600 transition-colors">
                            Learn More
                        </a>
                    </div>
                </div>
